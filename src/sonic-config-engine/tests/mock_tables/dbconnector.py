...
_old_connect_ConfigDBConnector = ConfigDBConnector.connect

def connect_ConfigDBConnector(self, wait_for_init=True, retry_on=False):
    ...
    self.dbintf.redis_kwargs['db_name'] = 'CONFIG_DB'
    self.dbintf.redis_kwargs['decode_responses'] = True
    _old_connect_ConfigDBConnector(self, wait_for_init, retry_on)
...
ConfigDBConnector.connect = connect_ConfigDBConnector
