...
#         self.assertEqual(output.strip(), "{'everflow0': {'src_ip': '10.1.0.32', 'dst_ip': '2.2.2.2'}}")
    ...
    def test_minigraph_port_autonegotiation(self):
        ...
        self.assertEqual(output.strip(),
                ...
                "'Ethernet100': {'lanes': '125,126,127,128', 'description': 'fortyGigE0/100', 'pfc_asym': 'off', 'mtu': '9100', 'alias': 'fortyGigE0/100', 'admin_status': 'up'}, "
        ...
        self.assertEqual(output.strip(),
                ...
                "'Ethernet100': {'lanes': '125,126,127,128', 'description': 'fortyGigE0/100', 'pfc_asym': 'off', 'mtu': '9100', 'alias': 'fortyGigE0/100', 'admin_status': 'up', 'autoneg': '0'}, "
    ...
    def test_minigraph_extra_ethernet_interfaces(self):
        ...
        self.assertEqual(output.strip(), \
            ...
            "'Ethernet16': {'lanes': '41,42,43,44', 'description': 'fortyGigE0/16', 'mtu': '9100', 'alias': 'fortyGigE0/16', 'pfc_asym': 'off', 'speed': '1000'}, "
