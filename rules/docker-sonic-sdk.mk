...
$(DOCKER_SONIC_SDK)_DEPENDS += $(LIBSAIREDIS) \
                               $(LIBSAIMETADATA)
$(DOCKER_SONIC_SDK)_LOAD_DOCKERS += $(DOCKER_CONFIG_ENGINE_BULLSEYE)

$(DOCKER_SONIC_SDK)_DBG_DEPENDS = $($(DOCKER_CONFIG_ENGINE_BULLSEYE)_DBG_DEPENDS) \
                                  $(LIBSAIREDIS_DBG) \
                                  $(LIBSAIMETADATA_DBG)
$(DOCKER_SONIC_SDK)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_BULLSEYE)_DBG_IMAGE_PACKAGES)
...
SONIC_BULLSEYE_DOCKERS  += $(DOCKER_SONIC_SDK)
SONIC_BULLSEYE_DBG_DOCKERS  += $(DOCKER_SONIC_SDK_DBG)
