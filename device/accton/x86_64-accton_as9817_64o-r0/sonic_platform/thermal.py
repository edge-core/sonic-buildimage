...
# Default thresholds
DEFAULT_THRESHOLD = {
    'MB_RearCenter_temp(0x48)' : {
        HIGH_THRESHOLD : '70.9',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '80.9',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'MB_RearRight_temp(0x49)' : {
        HIGH_THRESHOLD : '58.6',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '68.6',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'MB_RearCenter_temp(0x4A)' : {
        HIGH_THRESHOLD : '74.8',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '84.8',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'MB_RearLeft_temp(0x4B)' : {
        HIGH_THRESHOLD : '68.4',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '78.4',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'MB_FrontLeft_temp(0x4C)' : {
        HIGH_THRESHOLD : '73.0',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '83.0',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'MB_FrontRight_temp(0x4D)' : {
        HIGH_THRESHOLD : '59.1',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '69.1',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'FB_temp(0x4D)' : {
        HIGH_THRESHOLD : '60.8',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '70.8',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'FB_temp(0x4E)' : {
        HIGH_THRESHOLD : '60.9',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '70.9',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'CPU_Package_temp' : {
        HIGH_THRESHOLD : '90.0',
    ...
    'PSU-1 temp sensor 1' : {
        HIGH_THRESHOLD : '70.0',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '75.0',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'PSU-1 temp sensor 2' : {
        HIGH_THRESHOLD : '125.0',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '130.0',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'PSU-1 temp sensor 3' : {
        HIGH_THRESHOLD : '110.0',
        LOW_THRESHOLD : NOT_AVAILABLE,
        HIGH_CRIT_THRESHOLD : '115.0',
        LOW_CRIT_THRESHOLD : NOT_AVAILABLE
    },
    'PSU-2 temp sensor 1' : {
        HIGH_THRESHOLD : '70.0',
...
HWMON_PATH = {
    True: {
            0: {
                0: {"hwmon_path":"as9817_64_psu.0/hwmon/hwmon*/psu1", "ss_index":1},
                1: {"hwmon_path":"as9817_64_psu.0/hwmon/hwmon*/psu1", "ss_index":2},
                2: {"hwmon_path":"as9817_64_psu.0/hwmon/hwmon*/psu1", "ss_index":3},
            },
            1: {
                0: {"hwmon_path":"as9817_64_psu.1/hwmon/hwmon*/psu2", "ss_index":1},
                1: {"hwmon_path":"as9817_64_psu.1/hwmon/hwmon*/psu2", "ss_index":2},
                2: {"hwmon_path":"as9817_64_psu.1/hwmon/hwmon*/psu2", "ss_index":3},
            }
    },
    False: {
            0: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":1},
            1: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":2},
            2: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":3},
            3: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":4},
            4: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":5},
            5: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":6},
            6: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":7},
            7: {"hwmon_path":"as9817_64_thermal/hwmon/hwmon*/", "ss_index":8},
            8: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":1},
            9: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":2},
            10: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":3},
            11: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":4},
            12: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":5}
    }
}
