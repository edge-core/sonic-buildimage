        ...
        if changed_ports != 0:
            for sfp in self._sfp_list:
                ...
                if (bitmap & (1 << i)) == 0:
                    ...
                    # In xcvrd, its current implementation does not
                    # expect to identify the value when more than one bit is set 
                    # in the return value, and will run into the problem
                    #
                    port_dict[i+1] = '1'
