...
THERMAL_NAME_LIST = ["MB_FrontMiddle_temp(0x48)", "MB_RightCenter_temp(0x49)", "MB_LeftCenter_temp(0x4A)", 
                     "CB_temp(0x4B)", "OCXO_temp(0x4C)", "FB_1_temp(0x4E)" ,
                     "FB_2_temp(0x4F)", "CPU_Package_temp", "CPU_Core_0_temp",
                     "CPU_Core_1_temp", "CPU_Core_2_temp", "CPU_Core_3_temp"]
...
class Thermal(ThermalBase):
    ...
    def __init__(self, thermal_index=0, is_psu=False, psu_index=0, fan_dir=1):
        ...
        # The thermal policy configuration table is referenced from the accton_as9716_32d_monitor.py
        ...
        thermal_policy_config_table = {
            0: {
                THERMAL_NAME_LIST[0]: ('72.0', '78.0'),
                THERMAL_NAME_LIST[1]: ('72.0', '78.0'),
                THERMAL_NAME_LIST[2]: ('72.0', '78.0'),
                THERMAL_NAME_LIST[3]: ('60.0', '70.0'),
                THERMAL_NAME_LIST[4]: ('72.0', '78.0'),
                THERMAL_NAME_LIST[5]: ('72.0', '78.0'),
                THERMAL_NAME_LIST[6]: ('72.0', '78.0'),
                THERMAL_NAME_LIST[7]: ('81.0', '87.0'),
                THERMAL_NAME_LIST[8]: ('81.0', '87.0'),
                THERMAL_NAME_LIST[9]: ('81.0', '87.0'),
                THERMAL_NAME_LIST[10]: ('81.0', '87.0'),
                THERMAL_NAME_LIST[11]: ('81.0', '87.0')
            },
            1: {
                THERMAL_NAME_LIST[0]: ('65.0', '71.0'),
                THERMAL_NAME_LIST[1]: ('58.0', '64.0'),
                THERMAL_NAME_LIST[2]: ('57.0', '63.0'),
                THERMAL_NAME_LIST[3]: ('50.0', '56.0'),
                THERMAL_NAME_LIST[4]: ('57.0', '63.0'),
                THERMAL_NAME_LIST[5]: ('57.0', '63.0'),
                THERMAL_NAME_LIST[6]: ('60.0', '66.0'),
                THERMAL_NAME_LIST[7]: ('60.0', '66.0'),
                THERMAL_NAME_LIST[8]: ('60.0', '66.0'),
                THERMAL_NAME_LIST[9]: ('60.0', '66.0'),
                THERMAL_NAME_LIST[10]: ('60.0', '66.0'),
                THERMAL_NAME_LIST[11]: ('60.0', '66.0')
            }
        }
        ...
        # Set hwmon path
        i2c_path = {
            0: {"hwmon_path":"18-0048/hwmon/hwmon*/", "ss_index":1},
            1: {"hwmon_path":"18-0049/hwmon/hwmon*/", "ss_index":1},
            2: {"hwmon_path":"18-004a/hwmon/hwmon*/", "ss_index":1},
            3: {"hwmon_path":"18-004b/hwmon/hwmon*/", "ss_index":1},
            4: {"hwmon_path":"18-004c/hwmon/hwmon*/", "ss_index":1},
            5: {"hwmon_path":"18-004e/hwmon/hwmon*/", "ss_index":1},
            6: {"hwmon_path":"18-004f/hwmon/hwmon*/", "ss_index":1},
            7: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":1},
            8: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":2},
            9: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":3},
            10: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":4},
            11: {"hwmon_path":"coretemp.0/hwmon/hwmon*/", "ss_index":5}
        }.get(self.index, None)

        self.is_cpu = False
        if self.index in range(7,12):
            self.is_cpu = True
