...
THERMAL_SENSOR_LIST = [
    ...
    },
    {
        ...
        'support_mask': 0x01,
        'ext_sysfile_list': {1:['bmc_sersor_1', 'temp_r_b_f_max', 'temp_r_b_f_min', 'temp_r_b_f_crit', 'temp_r_b_f_lcrit']}
    },
    {
        'name': "G781(U94)",
        'temp_index': [1],
        ...
        'support_mask': 0x01,
        'ext_sysfile_list': {1:['bmc_sersor_2', 'temp_r_b_f_max', 'temp_r_b_f_min', 'temp_r_b_f_crit', 'temp_r_b_f_lcrit']}
    },
    {
        'name': "G781(U4)",
        'temp_index': [1],
        ...
        'support_mask': 0x01,
        'ext_sysfile_list': {1:['bmc_sersor_3', 'temp_r_b_f_max', 'temp_r_b_f_min', 'temp_r_b_f_crit', 'temp_r_b_f_lcrit']}
    },
    {
        'name': "G781(U34)",
        'temp_index': [1],
        ...
        'support_mask': 0x01,
        'ext_sysfile_list': {1:['bmc_sersor_4', 'temp_r_b_f_max', 'temp_r_b_f_min', 'temp_r_b_f_crit', 'temp_r_b_f_lcrit']}
    }
...
PSU_INFO = {
    'PSU1': {
        ...
        'status_path': "/sys/class/hwmon/hwmon2/device/ESC601_PSU/"
    },
    'PSU2': {
        'attr_path': "WILL BE RE-INIT",
        'status_path': "/sys/class/hwmon/hwmon2/device/ESC601_PSU/"
...
FAN_INFO = {
    'FAN1': {
        'isdraw': True,
        'fan_num': 2,
        'attr_path': '/sys/class/hwmon/hwmon2/device/ESC601_FAN/'
    },
    'FAN2': {
        'isdraw': True,
        'fan_num': 2,
...
# 0: QSFP
# 1: SFP
# sfp not port on 602 platform

SFP_EXT_SYSFILE_LIST = ["/sys/class/hwmon/hwmon2/device/ESC601_QSFP/",""]
...
class PlatDev():
    def __init__(self):
        ...
        for i in range(2, len(THERMAL_SENSOR_LIST)):
            ...
            if install_info and install_info.get('hwmon_path'):
                if self.bmc_is_exist():
                    THERMAL_SENSOR_LIST[i]['sysfile_path'] = '/sys/class/hwmon/hwmon2/device/ESC601_BMC/'
                else:
        ...
        for psu_name in PSU_LIST:
            ...
            if install_info:
                if self.bmc_is_exist():
                    self.psu_info[psu_name]['attr_path']= '/sys/class/hwmon/hwmon2/device/ESC601_PSU/'
                else:
    ...
    def get_fan_support(self):
        ...
        if os.path.exists(filePath):
            value = self.__read_attr_file(filePath)
            if value == 'ERR':
                return False
