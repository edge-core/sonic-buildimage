...
static const struct i2c_device_id at24_ids[] = {
	{ "24c64smbus",	AT24_DEVICE_MAGIC(65536 / 8,	AT24_FLAG_ADDR16) },
    { "24c08smbus",	AT24_DEVICE_MAGIC(8192 / 8,	0) },
    { "24c04smbus",	AT24_DEVICE_MAGIC(4096 / 8,	0) },
	{ /* END OF LIST */ }
};
				      ...
				      unsigned int offset, size_t count)
{
	...
	if (count > I2C_SMBUS_BLOCK_MAX)
        ...
        if(at24->chip.flags & AT24_FLAG_ADDR16){
              ...
              status =  i2c_smbus_write_byte_data(client, offset>>8,
			      offset&0xff); 
              if(status < 0)
                  return status;         
