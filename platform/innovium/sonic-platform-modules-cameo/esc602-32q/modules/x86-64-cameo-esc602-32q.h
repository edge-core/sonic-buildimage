...
/* i2c-0 */
static struct attribute *ESC602_SYS_attributes[] =
{
...
static struct attribute *ESC602_LED_attributes[] =
{
...
static struct attribute *ESC602_THERMAL_attributes[] =
{
...
static struct attribute *ESC602_FAN_attributes[] =
{
...
static struct attribute *ESC602_POWER_attributes[] =
{
...
static struct attribute *ESC602_QSFP_attributes[] =
{
...
static const struct attribute_group ESC602_SYS_group =
{
    .name  = "ESC602_SYS",
    .attrs = ESC602_SYS_attributes,
};

static const struct attribute_group ESC602_LED_group =
{
    .name  = "ESC602_LED",
    .attrs = ESC602_LED_attributes,
};

static const struct attribute_group ESC602_THERMAL_group =
{
    .name  = "ESC602_THERMAL",
    .attrs = ESC602_THERMAL_attributes,
};

static const struct attribute_group ESC602_FAN_group =
{
    .name  = "ESC602_FAN",
    .attrs = ESC602_FAN_attributes,
};

static const struct attribute_group ESC602_POWER_group =
{
    .name  = "ESC602_POWER",
    .attrs = ESC602_POWER_attributes,
};

static const struct attribute_group ESC602_QSFP_group =
{
    .name  = "ESC602_QSFP",
    .attrs = ESC602_QSFP_attributes,
};
