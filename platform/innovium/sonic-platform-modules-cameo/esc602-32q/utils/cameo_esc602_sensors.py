...
BMC_SYSFILE_PATH            = '/sys/class/hwmon/hwmon2/device/ESC602_SYS/'
FAN_SYSFILE_PATH            = '/sys/class/hwmon/hwmon2/device/ESC602_FAN/'
POWER_SYSFILE_PATH          = '/sys/class/hwmon/hwmon2/device/ESC602_POWER/'
THERMAL_SYSFILE_PATH        = '/sys/class/hwmon/hwmon2/device/ESC602_THERMAL/'
