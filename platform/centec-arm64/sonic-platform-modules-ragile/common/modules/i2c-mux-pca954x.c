        ...
        .pca9548_cfg_info  = {
            /* SOC */
            {
                ...
                .attr = {
                    .gpio_attr.gpio           = 509,
                    .gpio_attr.gpio_init      = 0,
                    .gpio_attr.reset_on       = 0,
                    .gpio_attr.reset_off      = 1,
                },
            },
            /* SFP+ */
            {
				...
				void *client, u32 chan)
{
    ...
    if (ret < 0) {
        new_client =(struct i2c_client *) client;
        dev_warn(&new_client->dev, "pca954x close chn failed, do reset.\n");
        rv = pca954x_do_reset(adap, client, chan);
        if (rv == 0) {
            ret = 0;
        }
    ...
    (void)pca954x_reg_write(adap, client, data->last_chan);
