...
QUANTA_IX7_BWDE_32X_PLATFORM_MODULE_VERSION = 1.0
QUANTA_IX8_56X_PLATFORM_MODULE_VERSION = 1.0
QUANTA_IX8A_BWDE_56X_PLATFORM_MODULE_VERSION = 1.0
...
export QUANTA_IX7_BWDE_32X_PLATFORM_MODULE_VERSION
export QUANTA_IX8_56X_PLATFORM_MODULE_VERSION
export QUANTA_IX8A_BWDE_56X_PLATFORM_MODULE_VERSION
...
QUANTA_IX7_BWDE_32X_PLATFORM_MODULE = sonic-platform-quanta-ix7-bwde-32x_$(QUANTA_IX7_BWDE_32X_PLATFORM_MODULE_VERSION)_amd64.deb
$(QUANTA_IX7_BWDE_32X_PLATFORM_MODULE)_PLATFORM = x86_64-quanta_ix7_bwde-r0
$(eval $(call add_extra_package,$(QUANTA_IX1B_32X_PLATFORM_MODULE),$(QUANTA_IX7_BWDE_32X_PLATFORM_MODULE)))
...
QUANTA_IX8A_BWDE_56X_PLATFORM_MODULE = sonic-platform-quanta-ix8a-bwde-56x_$(QUANTA_IX8A_BWDE_56X_PLATFORM_MODULE_VERSION)_amd64.deb
$(QUANTA_IX8A_BWDE_56X_PLATFORM_MODULE)_PLATFORM = x86_64-quanta_ix8a_bwde-r0
$(eval $(call add_extra_package,$(QUANTA_IX1B_32X_PLATFORM_MODULE),$(QUANTA_IX8A_BWDE_56X_PLATFORM_MODULE)))
