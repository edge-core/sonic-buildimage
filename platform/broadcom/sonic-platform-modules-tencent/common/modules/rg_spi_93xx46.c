...
int g_rg_spi_93xx46_debug = 0;
int g_rg_spi_93xx46_error = 0;
int spi_bus_num = DEFAULT_SPI_BUS_NUM;
int spi_cs_gpio = GPIO_EEPROM_CS;

module_param(g_rg_spi_93xx46_debug, int, S_IRUGO | S_IWUSR);
module_param(g_rg_spi_93xx46_error, int, S_IRUGO | S_IWUSR);
...
static int __init rg_spi_93xx46_init(void)
{
...
static void __exit rg_spi_93xx46_exit(void)
{
...
module_init(rg_spi_93xx46_init);
module_exit(rg_spi_93xx46_exit);
