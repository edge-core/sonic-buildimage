...
extern const struct regulator_ops rg_pmbus_regulator_ops;
...
int rg_pmbus_write_word_data(struct i2c_client *client, int page, u8 reg, u16 word);
...
int rg_pmbus_write_byte_data(struct i2c_client *client, int page, u8 reg,
			  u8 value);
