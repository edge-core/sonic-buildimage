#ifndef _RG_PLAT_SWITCH_H_
#define _RG_PLAT_SWITCH_H_
...
extern struct switch_obj *rg_plat_kobject_create(const char *name, struct kobject *parent);
extern void rg_plat_kobject_delete(struct switch_obj **obj);

#endif /* _RG_PLAT_SWITCH_H_ */
