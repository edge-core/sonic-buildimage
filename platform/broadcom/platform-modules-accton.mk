...
ACCTON_AS9736_64D_PLATFORM_MODULE_VERSION = 1.1
...
ACCTON_AS4625_54P_PLATFORM_MODULE_VERSION = 1.1
ACCTON_AS4625_54T_PLATFORM_MODULE_VERSION = 1.1
ACCTON_AS9817_64O_PLATFORM_MODULE_VERSION = 1.1
ACCTON_AS9817_64D_PLATFORM_MODULE_VERSION = 1.1
ACCTON_AS9737_32DB_PLATFORM_MODULE_VERSION = 1.1
ACCTON_AS9817_32O_PLATFORM_MODULE_VERSION = 1.1
ACCTON_AS9817_32D_PLATFORM_MODULE_VERSION = 1.1
...
export ACCTON_AS9736_64D_PLATFORM_MODULE_VERSION
...
export ACCTON_AS4625_54T_PLATFORM_MODULE_VERSION
export ACCTON_AS9817_64O_PLATFORM_MODULE_VERSION
export ACCTON_AS9817_64D_PLATFORM_MODULE_VERSION
export ACCTON_AS9737_32DB_PLATFORM_MODULE_VERSION
export ACCTON_AS9817_32O_PLATFORM_MODULE_VERSION
export ACCTON_AS9817_32D_PLATFORM_MODULE_VERSION
...
ACCTON_AS9736_64D_PLATFORM_MODULE = sonic-platform-accton-as9736-64d_$(ACCTON_AS9736_64D_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS9736_64D_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as9736_64d-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS9736_64D_PLATFORM_MODULE)))
...
ACCTON_AS4625_54P_PLATFORM_MODULE = sonic-platform-accton-as4625-54p_$(ACCTON_AS4625_54P_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS4625_54P_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as4625_54p-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS4625_54P_PLATFORM_MODULE)))

ACCTON_AS4625_54T_PLATFORM_MODULE = sonic-platform-accton-as4625-54t_$(ACCTON_AS4625_54T_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS4625_54T_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as4625_54t-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS4625_54T_PLATFORM_MODULE)))

ACCTON_AS9817_64O_PLATFORM_MODULE = sonic-platform-accton-as9817-64o_$(ACCTON_AS9817_64O_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS9817_64O_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as9817_64o-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS9817_64O_PLATFORM_MODULE)))

ACCTON_AS9817_64D_PLATFORM_MODULE = sonic-platform-accton-as9817-64d_$(ACCTON_AS9817_64D_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS9817_64D_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as9817_64d-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS9817_64D_PLATFORM_MODULE)))

ACCTON_AS9737_32DB_PLATFORM_MODULE = sonic-platform-accton-as9737-32db_$(ACCTON_AS9737_32DB_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS9737_32DB_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as9737_32db-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS9737_32DB_PLATFORM_MODULE)))

ACCTON_AS9817_32O_PLATFORM_MODULE = sonic-platform-accton-as9817-32o_$(ACCTON_AS9817_32O_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS9817_32O_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as9817_32o-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS9817_32O_PLATFORM_MODULE)))

ACCTON_AS9817_32D_PLATFORM_MODULE = sonic-platform-accton-as9817-32d_$(ACCTON_AS9817_32D_PLATFORM_MODULE_VERSION)_amd64.deb
$(ACCTON_AS9817_32D_PLATFORM_MODULE)_PLATFORM = x86_64-accton_as9817_32d-r0
$(eval $(call add_extra_package,$(ACCTON_AS7712_32X_PLATFORM_MODULE),$(ACCTON_AS9817_32D_PLATFORM_MODULE)))
