 ...
 *
 * The original code reads spi_busy_reg in a tight loop.  On AS9817, this
...
#else
static int __init ocores_i2c_as9817_32_init(void)
{
    int err;
...
static void __exit ocores_i2c_as9817_32_exit(void)
{
    platform_driver_unregister(&ocores_i2c_driver);

}

module_init(ocores_i2c_as9817_32_init);
module_exit(ocores_i2c_as9817_32_exit);
#endif
