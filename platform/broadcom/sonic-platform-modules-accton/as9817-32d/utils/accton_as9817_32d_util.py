...
"""
usage: accton_as9817_32d_util.py [-h] [-d] [-f] {install,clean,threshold} ...

AS9817-32D Platform Utility
...
def main():
    ...
    util_parser = argparse.ArgumentParser(description="AS9817-32D Platform Utility")
...
apply_ais800_cmds = [
    f"sed -i 's/\"name\":\ \"AS9817-32D\"/\"name\":\ \"AIS800-32D\"/g' {device_path}/platform.json",
...
apply_as9817_cmds = [
    f"sed -i 's/\"name\":\ \"AIS800-32D\"/\"name\":\ \"AS9817-32D\"/g' {device_path}/platform.json",
...
apply_cmd_sets = {
    ...
    0x02 : apply_ais800_cmds, # OSFP DC-SCM
    0x03 : apply_ais800_cmds  # QDD DC-SCM
}
