...
i2cset -y 0 0x1a 0xff 0x05
i2cset -y 0 0x1b 0xff 0x05
...
i2cset -y 0 0x1a 0x2d 0x82
i2cset -y 0 0x1b 0x2d 0x82

#write de-emphasis to -3.5dB
i2cset -y 0 0x18 0x15 0x12
i2cset -y 0 0x19 0x15 0x12
i2cset -y 0 0x1a 0x15 0x12
i2cset -y 0 0x1b 0x15 0x12


#invert the polarity of the driver
i2cset -y 0 0x18 0x1f 0xd5
i2cset -y 0 0x19 0x1f 0xd5
i2cset -y 0 0x1a 0x1f 0xd5
i2cset -y 0 0x1b 0x1f 0xd5
#clr channel B
i2cset -y 0 0x18 0xff 0x00
i2cset -y 0 0x19 0xff 0x00
i2cset -y 0 0x1a 0xff 0x00
i2cset -y 0 0x1b 0xff 0x00
