#!/bin/bash
#
# The front panel management port is the I210 at the PCI address declared as
# eth0 in /etc/udev/rules.d/70-persistent-net.rules. The other I210 is parked
# at eth4 by the same rule file.
#
