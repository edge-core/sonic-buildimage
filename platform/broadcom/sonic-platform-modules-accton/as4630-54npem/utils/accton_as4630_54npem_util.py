...
"""
usage: accton_as4630_54npem_util.py [-h] [-d] [-f] {install,clean,api,api_clean,threshold} ...

AS4630-54NPEM Platform Utility
...
mknod = [
    ...
    'echo as4630_54npem_cpld 0x60 > /sys/bus/i2c/devices/i2c-3/new_device',
    ...
    # PSU-1
    'echo as4630_54npem_psu1 0x50 > /sys/bus/i2c/devices/i2c-10/new_device',
    'echo ype1200am 0x58 > /sys/bus/i2c/devices/i2c-10/new_device',

    # PSU-2
    'echo as4630_54npem_psu2 0x51> /sys/bus/i2c/devices/i2c-11/new_device',
...
def main():
    ...
    util_parser = argparse.ArgumentParser(description="AS4630-54NPEM Platform Utility")
...
kos = [
    ...
    'modprobe ym2651y',
    'modprobe x86_64_accton_as4630_54npem_cpld',
    'modprobe x86_64_accton_as4630_54npem_leds',
    'modprobe x86_64_accton_as4630_54npem_psu',
    'modprobe optoe']
