...
# HISTORY:
#    mm/dd/yyyy (A.D.)#
#    10/24/2019:Jostar create for as4630_54npem thermal plan
# ------------------------------------------------------------------
...
try:
    ...
    import time
    from as4630_54npem.fanutil import FanUtil
    from as4630_54npem.thermalutil import ThermalUtil
except ImportError as e:
    raise ImportError('%s - required module not found' % str(e))

# Deafults
VERSION = '1.0'
FUNCTION_NAME = '/usr/local/bin/accton_as4630_54npem_monitor'
