...
#define PMBUS_REGISTER_READ_VIN_MIN             0xa0
#define PMBUS_REGISTER_READ_VIN_MAX             0xa1
#define PMBUS_REGISTER_READ_IIN_MAX             0xa2
#define PMBUS_REGISTER_READ_PIN_MAX             0xa3
#define PMBUS_REGISTER_READ_VOUT_MIN            0xa4
#define PMBUS_REGISTER_READ_VOUT_MAX            0xa5
...
static struct accton_i2c_psu_data *accton_i2c_psu_update_device(struct device *dev)
{
    ...
    if (time_after(jiffies, data->last_updated + HZ + HZ / 2)
        ...
        struct reg_data_word regs_word[] = { {PMBUS_REGISTER_READ_VIN, &data->v_in},
                                             ...
                                             {PMBUS_REGISTER_READ_VIN_MIN, &data->mfr_vin_min},
                                             {PMBUS_REGISTER_READ_VIN_MAX, &data->mfr_vin_max},
                                             {PMBUS_REGISTER_READ_IIN_MAX, &data->mfr_iin_max},
                                             {PMBUS_REGISTER_READ_PIN_MAX, &data->mfr_pin_max},
                                             {PMBUS_REGISTER_READ_VOUT_MIN, &data->mfr_vout_min},
                                             {PMBUS_REGISTER_READ_VOUT_MAX, &data->mfr_vout_max},
