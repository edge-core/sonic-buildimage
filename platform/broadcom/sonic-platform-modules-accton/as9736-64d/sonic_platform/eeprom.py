...
class Tlv(eeprom_tlvinfo.TlvInfoDecoder):
    ...
    def __init__(self):
        ...
        self._eeprom_path = "/sys/bus/i2c/devices/20-0051/eeprom"
    ...
    def get_pn(self):
        return self._eeprom.get(TLV_PART_NUMBER, NULL)

    def get_serial(self):
        return self._eeprom.get(TLV_SERIAL_NUMBER, NULL)

    def get_mac(self):
        return self._eeprom.get(TLV_BASE_MAC_ADDRESS, NULL)
