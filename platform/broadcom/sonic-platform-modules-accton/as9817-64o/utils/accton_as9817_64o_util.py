...
"""
usage: accton_as9817_64o_util.py [-h] [-d] [-f] {install,clean,threshold} ...

AS9817-64O Platform Utility
...
def main():
    ...
    util_parser = argparse.ArgumentParser(description="AS9817-64O Platform Utility")
